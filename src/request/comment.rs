...
use crate::{
    model::level::Level,
    request::{BaseRequest, GD_19, REQUEST_BASE_URL},
};
use serde::Serialize;
...
mod tests {
    ...
    fn serialize_profile_comments() {
        ...
        assert_eq!(
            super::super::to_string(request),
            "gameVersion=19&binaryVersion=24&secret=Wmfd2893gb7&total=0&page=2&accountID=1710032"
        );
    }
}
